    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl border-2 border-gray-200 px-4 py-3 text-sm font-semibold text-gray-700 hover:shadow-md transition-all"
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          @holidayextras.com accounts only · Holiday Extras Internal Tool
        </p>
      </div>
    </div>
  );
